...
This document describes how to copy and customise the evergreen-clean (bootstrapbase) theme so that
...
From your Moodle theme directory right click on evergreen-clean and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of evergreen-clean.
...
underscores. For the purpose of this tutorial we will call the theme 'evergreen-cleantheme'.

On opening 'evergreen-cleantheme' your you will find several files and sub-directories which have
files within them.
...
/lang/en/theme_evergreen-clean.php
...
where the old theme name occurs, in this case evergreen-clean. So using the above list as
a guide, search through and change all the instances of the theme name
'evergreen-clean' to 'evergreen-cleantheme'. This includes the filename of the lang/en/theme_evergreen-clean.php.
You need to change this to 'theme_evergreen-cleantheme.php'.
...
and then click on (evergreen-cleantheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the evergreen-clean theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > evergreen-clean
