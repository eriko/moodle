...
/**
 * Strings for component 'theme_evergreen_archive', language 'en'
 *
...
<div class="well">
<h3>About</h3>
<p>Evergreen Archive is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
